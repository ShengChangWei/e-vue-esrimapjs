(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["e-vue-esrimapjs"] = factory();
	else
		root["e-vue-esrimapjs"] = factory();
...
"use strict";
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_index_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_lib_loader_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_e_vue_esrimapjs_vue_vue_type_style_index_0_id_87e265b2_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("c620");
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_index_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_lib_loader_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_e_vue_esrimapjs_vue_vue_type_style_index_0_id_87e265b2_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_index_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_lib_loader_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_e_vue_esrimapjs_vue_vue_type_style_index_0_id_87e265b2_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_index_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_lib_loader_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_e_vue_esrimapjs_vue_vue_type_style_index_0_id_87e265b2_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
// module
exports.push([module.i, ".e-vue-map[data-v-87e265b2]{position:relative}.e-vue-map[data-v-87e265b2],.e-vue-map .eMap[data-v-87e265b2]{width:100%;height:100%}.e-vue-map .eNavigation[data-v-87e265b2]{position:absolute;left:10px;bottom:10px;width:33px;height:120px;font-size:16px}.e-vue-map .eNavigation .zoom-map[data-v-87e265b2]{width:33px;height:36px;line-height:36px;cursor:pointer;text-align:center;color:#757575;background-color:#fff;-webkit-box-shadow:1px 1px 5px 0 #adaaaa;box-shadow:1px 1px 5px 0 #adaaaa}.e-vue-map .eNavigation .zoom-map.zoom-in-map[data-v-87e265b2]{border-bottom:1px solid #d9d9d9}.e-vue-map .eNavigation .zoom-map.full-map[data-v-87e265b2]{margin-bottom:10px}.e-vue-map .eNavigation .zoom-map[data-v-87e265b2]:hover{color:#03a9f4}.e-vue-map .eNavigation .zoom-map.zoom-disable[data-v-87e265b2]{color:#bebebe;cursor:auto}.e-vue-map .eNavigation .zoom-map.zoom-disable[data-v-87e265b2]:hover{color:#bebebe}", ""]);
...
// load the styles
var content = __webpack_require__("aeb1");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = __webpack_require__("499e").default
var update = add("36362fc1", content, true, {"sourceMap":false,"shadowMode":false});
...
// CONCATENATED MODULE: ./packages/e-vue-esrimapjs/e-vue-esrimapjs.vue?vue&type=template&id=87e265b2&scoped=true&
...
var e_vue_esrimap_loader_EVueErimapLoader =
/*#__PURE__*/
function () {
...
/* harmony default export */ var e_vue_esrimapjsvue_type_script_lang_js_ = ({
  ...
  props: {
    ...
    mapUrl: {
      type: [String, Array],
      default: 'http://server.arcgisonline.com/ArcGIS/rest/services/ESRI_StreetMap_World_2D/MapServer'
    },
    submapUrl: {
      type: Array,
  ...
  methods: {
    ...
    initMap: function initMap() {
      ...
      if (this.mapType === 'tdt') {
        // 初始底图
        this.getTdtLayer(is_array_default()(this.mapUrl) ? this.mapUrl : [this.mapUrl]).then(function () {
        ...
        this.submapUrl.forEach(function () {
          ...
          _this3.getTdtLayer(is_array_default()(submap) ? submap : [submap]).then(function () {
            var layers = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
            var baseamapLayerIds = [];
            layers.forEach(function (layer, index) {
        ...
        this.submapUrl.forEach(function () {
          ...
          _this3.getBaiduLayer(is_array_default()(submap) ? submap : [submap]).then(function () {
            var layers = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
            console.log(layers);
            var baseamapLayerIds = [];
            layers.forEach(function (layer, index) {
    ...
    getTdtLayer: function getTdtLayer() {
      ...
      var layers = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
      return new promise_default.a(function (resolve) {
        var tileInfo = new _this4.TileInfo({
          rows: 256,
          cols: 256,
        ...
        layers.forEach(function (type) {
          var templateUrl = 'http://${subDomain}.tianditu.gov.cn/DataServer?T=' + type + '_c&X=${col}&Y=${row}&L=${level}&tk=' + _this4.tdtTK;
      ...
      return new promise_default.a(function (resolve) {
        var tileInfo = new _this5.TileInfo({
          ...
          lods: [{
            ...
            templateUrl = 'http://${subDomain}.google.cn/vt/lyrs=' + layer + '&hl=zh-CN&gl=cn&x=${col}&y=${row}&z=${level}&s=Gali',
            googleLayer = new _this5.WebTiledLayer(templateUrl, {
          id: 'google_' + layer,
          subDomains: subDomains,
          tileInfo: tileInfo
        });
    ...
    getBaiduLayer: function getBaiduLayer() {
      ...
      return new promise_default.a(function (resolve) {
        ...
        layers.forEach(function (layer) {
          console.log(layer);
          var baiduLayer = new _this6.WebTiledLayer(templateUrl, {
            id: 'baidu_' + layer,
            tileInfo: tileInfo
          });
          ...
          baiduLayer.getTileUrl = function (level, row, col) {
            ...
            switch (layer) {
              ...
              default:
                templateUrl = 'http://maponline0.bdimg.com/tile/?qt=vtile&x=' + numX + '&y=' + numY + '&z=' + zoom + '&styles=pl&scaler=1&udt=20191119';
                break;
            }
    ...
    changeBaseLayer: function changeBaseLayer(layerIndex) {
      ...
      if (this.currBaseLayerIndex !== layerIndex) {
        this.basemapIds.forEach(function (mapIds, index) {
          if (layerIndex === index) {
            var prevBaseLayerIndex = _this7.currBaseLayerIndex;
            _this7.currBaseLayerIndex = layerIndex;

            if (is_array_default()(mapIds)) {
              mapIds.forEach(function (id) {
                _this7.map.getLayer(id).setVisibility(true);
              });
            } else {
              _this7.map.getLayer(mapIds).setVisibility(true);
            }

            _this7.$emit('baseLayerChange', {
              prev: prevBaseLayerIndex,
              curr: _this7.currBaseLayerIndex
            });
          } else {
            if (is_array_default()(mapIds)) {
              mapIds.forEach(function (id) {
                _this7.map.getLayer(id).setVisibility(false);
              });
            } else {
              _this7.map.getLayer(mapIds).setVisibility(false);
            }
          }
        });
      }
    ...
    addMapEvent: function addMapEvent() {
      ...
      this.map.on('load', function () {
        if (_this8.newInitExtent) {
          _this8.fit = true;

          _this8.setExtent(_this8.newInitExtent, _this8.fit).then(function () {
            _this8.$emit('mapReady', _this8);
          });
        } else {
          _this8.newInitExtent = _this8.map.extent;

          _this8.$emit('mapReady', _this8);
        }
      });
      this.map.on('extent-change', function (event) {
        _this8.isMax = _this8.map.getZoom() >= _this8.map.getMaxZoom();
        _this8.isMin = _this8.map.getZoom() <= _this8.map.getMinZoom();

        _this8.$emit('exentChange', event);
      });
    },
    ...
    gpAsyncGetResultImageLayer: function gpAsyncGetResultImageLayer(params) {
      ...
      var gp = new this.Geoprocessor(params.url);
      gp.submitJob(params.inParamVal, function (jobInfo) {
        var imageParameters = new _this9.ImageParameters();
        imageParameters.imageSpatialReference = _this9.map.spatialReference;
    ...
    locationPoint: function locationPoint(point) {
      ...
      this.timeOutId = window.setTimeout(function () {
        window.clearTimeout(_this10.timeOutId);

        _this10.locationLayer.clear();
      }, 10000);
    },
...
// EXTERNAL MODULE: ./packages/e-vue-esrimapjs/e-vue-esrimapjs.vue?vue&type=style&index=0&id=87e265b2&lang=scss&scoped=true&
var e_vue_esrimapjsvue_type_style_index_0_id_87e265b2_lang_scss_scoped_true_ = __webpack_require__("715c");
...
//# sourceMappingURL=e-vue-esrimapjs.umd.js.map