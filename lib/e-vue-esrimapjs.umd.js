...
// module
exports.push([module.i, ".e-vue-map[data-v-25e64a04]{position:relative}.e-vue-map[data-v-25e64a04],.e-vue-map .eMap[data-v-25e64a04]{width:100%;height:100%}.e-vue-map .eNavigation[data-v-25e64a04]{position:absolute;left:10px;bottom:10px;width:33px;height:120px;font-size:16px}.e-vue-map .eNavigation .zoom-map[data-v-25e64a04]{width:33px;height:36px;line-height:36px;cursor:pointer;text-align:center;color:#757575;background-color:#fff;-webkit-box-shadow:1px 1px 5px 0 #adaaaa;box-shadow:1px 1px 5px 0 #adaaaa}.e-vue-map .eNavigation .zoom-map.zoom-in-map[data-v-25e64a04]{border-bottom:1px solid #d9d9d9}.e-vue-map .eNavigation .zoom-map.full-map[data-v-25e64a04]{margin-bottom:10px}.e-vue-map .eNavigation .zoom-map[data-v-25e64a04]:hover{color:#03a9f4}.e-vue-map .eNavigation .zoom-map.zoom-disable[data-v-25e64a04]{color:#bebebe;cursor:auto}.e-vue-map .eNavigation .zoom-map.zoom-disable[data-v-25e64a04]:hover{color:#bebebe}", ""]);
...
"use strict";
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_index_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_e_vue_esrimapjs_vue_vue_type_style_index_0_id_25e64a04_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("85e4");
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_index_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_e_vue_esrimapjs_vue_vue_type_style_index_0_id_25e64a04_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_index_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_e_vue_esrimapjs_vue_vue_type_style_index_0_id_25e64a04_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_index_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_e_vue_esrimapjs_vue_vue_type_style_index_0_id_25e64a04_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
// load the styles
var content = __webpack_require__("14cc");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = __webpack_require__("499e").default
var update = add("0a0ec2f6", content, true, {"sourceMap":false,"shadowMode":false});
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"4731a2db-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./packages/e-vue-esrimapjs/e-vue-esrimapjs.vue?vue&type=template&id=25e64a04&scoped=true&
...
// CONCATENATED MODULE: ./packages/e-vue-esrimapjs/e-vue-esrimapjs.vue?vue&type=template&id=25e64a04&scoped=true&
  ...
  methods: {
    ...
    initMap: function initMap() {
      ...
      if (this.mapType === 'tdt') {
        ...
        // 初始底图
        this.getMapboxLayer().then(function (layers) {
          _this3.map.addLayer(layers);
        });
    ...
    getTdtLayer: function getTdtLayer() {
      ...
      return new Promise(function (resolve) {
        ...
        layers.forEach(function (type) {
          var templateUrl = 'https://${subDomain}.tianditu.gov.cn/DataServer?T=' + type + '_c&X=${col}&Y=${row}&L=${level}&tk=' + _this4.tdtTK; //  const templateUrl =
    ...
    getMapboxLayer: function getMapboxLayer() {
      ...
      return new Promise(function (resolve) {
        var subDomains = ['a', 'b', 'c'],
            templateUrl = 'https://${subDomain}.tiles.mapbox.com/v4/mapbox.dark/${level}/${col}/${row}.png?access_token=pk.eyJ1Ijoid2xvbmxpbmUiLCJhIjoiY2s1MjFhMjM0MDN4OTNqcDhjbGY1d3N6ZiJ9.DqC7SXU6B5W-04B7vC6bBQ',
            mapBoxLayer = new _this7.WebTiledLayer(templateUrl, {
          id: 'mapBox',
          subDomains: subDomains
        });
        resolve(mapBoxLayer);
    ...
    changeBaseLayer: function changeBaseLayer(layerIndex) {
      ...
      if (this.currBaseLayerIndex !== layerIndex) {
        this.basemapIds.forEach(function (mapIds, index) {
          if (layerIndex === index) {
            var prevBaseLayerIndex = _this8.currBaseLayerIndex;
            _this8.currBaseLayerIndex = layerIndex;

            if (Array.isArray(mapIds)) {
              mapIds.forEach(function (id) {
                _this8.map.getLayer(id).setVisibility(true);
              });
            } else {
              _this8.map.getLayer(mapIds).setVisibility(true);
            }

            _this8.$emit('baseLayerChange', {
              prev: prevBaseLayerIndex,
              curr: _this8.currBaseLayerIndex
            });
          } else {
            if (Array.isArray(mapIds)) {
              mapIds.forEach(function (id) {
                _this8.map.getLayer(id).setVisibility(false);
              });
            } else {
              _this8.map.getLayer(mapIds).setVisibility(false);
            }
          }
        });
      }
    ...
    addMapEvent: function addMapEvent() {
      ...
      this.map.on('load', function () {
        if (_this9.newInitExtent) {
          _this9.fit = true;

          _this9.setExtent(_this9.newInitExtent, _this9.fit).then(function () {
            _this9.$emit('mapReady', _this9);
          });
        } else {
          _this9.newInitExtent = _this9.map.extent;

          _this9.$emit('mapReady', _this9);
        }
      });
      this.map.on('extent-change', function (event) {
        _this9.isMax = _this9.map.getZoom() >= _this9.map.getMaxZoom();
        _this9.isMin = _this9.map.getZoom() <= _this9.map.getMinZoom();

        _this9.$emit('exentChange', event);
      });
    },
    ...
    gpAsyncGetResultImageLayer: function gpAsyncGetResultImageLayer(params) {
      ...
      var gp = new this.Geoprocessor(params.url);
      gp.submitJob(params.inParamVal, function (jobInfo) {
        var imageParameters = new _this10.ImageParameters();
        imageParameters.imageSpatialReference = _this10.map.spatialReference;
    ...
    locationPoint: function locationPoint(point) {
      ...
      this.timeOutId = window.setTimeout(function () {
        window.clearTimeout(_this11.timeOutId);

        _this11.locationLayer.clear();
      }, 10000);
    },
...
// EXTERNAL MODULE: ./packages/e-vue-esrimapjs/e-vue-esrimapjs.vue?vue&type=style&index=0&id=25e64a04&lang=scss&scoped=true&
var e_vue_esrimapjsvue_type_style_index_0_id_25e64a04_lang_scss_scoped_true_ = __webpack_require__("42ce");
